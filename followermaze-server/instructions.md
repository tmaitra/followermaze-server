...
9. **maxEventSourceBatchSize** - Default: 100
   ...
   The test program batches messages of random sizes up to `maxEventSourceBatchSize`. It randomizes the order of 
   the messages in each batch. For example, if this configuration is "1" the test program
   will send ordered messages.
